/**
 * @license AngularJS v1.3.19-ie8.2
...
function minErr(module, ErrorConstructor) {
  ...
  return function() {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.19-ie8.2/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.19-ie8.2',    // all of these placeholder strings will be replaced by grunt's
  major: 1,    // package task
  minor: 3,
  dot: 19,
  codeName: 'ie8-smoothie'
};
