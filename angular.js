/**
 * @license AngularJS v1.3.19-local+sha.bfcc462
...
function minErr(module, ErrorConstructor) {
  ...
  return function() {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.19-local+sha.bfcc462/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.19-local+sha.bfcc462',    // all of these placeholder strings will be replaced by grunt's
